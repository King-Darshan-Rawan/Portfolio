const experiences = [
  {
    title: "B.Tech from SGSITS Indore",
  ...
  {
    title: "High School from Merit H.S. School",
    role: "PCM, Physics, Chemistry, Maths",
    date: "2020 - 2021",
    align: "right",
    icon: "🧠",
  },
  {
    title: "Schooling from Little Flower School",
    role: "All Subjects",
    date: "2018-2019",
    align: "left",
    icon: "⚙️",
    ...
    <div className="relative bg-gradient-to-b from-[#0a0a23] to-[#1A1F29] text-white py-20 ">
      <div className="max-w-5xl mx-auto px-4">
        ...
        <p className="text-center text-gray-400 mb-12">
          That is how i got my knowledge.
        </p>
